...
/**
 * Class BH_AWP_Auto_Generate_WooCommerce_Coupons_Test
 *
 * @see I18n
 */
class BH_AWP_Auto_Generate_WooCommerce_Coupons_I18n_Test extends \Codeception\TestCase\WPTestCase {
	...
	public function test_load_plugin_textdomain() {
		...
		$this->assertTrue( is_textdomain_loaded( 'bh-awp-auto-generate-woocommerce-coupons' ), 'i18n text domain not loaded.' );
